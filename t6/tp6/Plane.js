...
Plane.prototype.initBuffers = function() {
	...
	*/
	...
	var tinc = this.maxT / this.nrDivs;
	var sinc = this.maxS / this.nrDivs;

	for (var j = 0, t = this.minT; j <= this.nrDivs; j++, t += tinc) 
	{
		var xCoord = -0.5;
		for (var i = 0, s = this.minS; i <= this.nrDivs; i++, s+=sinc) 
		{
